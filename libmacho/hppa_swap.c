...
void
swap_hppa_integer_thread_state(struct hp_pa_integer_thread_state *regs, enum NXByteOrder target_byte_order)
{
    UNREFERENCED_PARAMETER(target_byte_order);
...
enum NXByteOrder target_byte_order)
{
	...
	fp->ts_fp0 = (double)OSSwapInt64((int64_t)fp->ts_fp0);
	fp->ts_fp1 = (double)OSSwapInt64((int64_t)fp->ts_fp1);
	fp->ts_fp2 = (double)OSSwapInt64((int64_t)fp->ts_fp2);
	fp->ts_fp3 = (double)OSSwapInt64((int64_t)fp->ts_fp3);
	fp->ts_fp4 = (double)OSSwapInt64((int64_t)fp->ts_fp4);
	fp->ts_fp5 = (double)OSSwapInt64((int64_t)fp->ts_fp5);
	fp->ts_fp6 = (double)OSSwapInt64((int64_t)fp->ts_fp6);
	fp->ts_fp7 = (double)OSSwapInt64((int64_t)fp->ts_fp7);
	fp->ts_fp8 = (double)OSSwapInt64((int64_t)fp->ts_fp8);
	fp->ts_fp9 = (double)OSSwapInt64((int64_t)fp->ts_fp9);
	fp->ts_fp10 = (double)OSSwapInt64((int64_t)fp->ts_fp10);
	fp->ts_fp11 = (double)OSSwapInt64((int64_t)fp->ts_fp11);
	fp->ts_fp12 = (double)OSSwapInt64((int64_t)fp->ts_fp12);
	fp->ts_fp13 = (double)OSSwapInt64((int64_t)fp->ts_fp13);
	fp->ts_fp14 = (double)OSSwapInt64((int64_t)fp->ts_fp14);
	fp->ts_fp15 = (double)OSSwapInt64((int64_t)fp->ts_fp15);
	fp->ts_fp16 = (double)OSSwapInt64((int64_t)fp->ts_fp16);
	fp->ts_fp17 = (double)OSSwapInt64((int64_t)fp->ts_fp17);
	fp->ts_fp18 = (double)OSSwapInt64((int64_t)fp->ts_fp18);
	fp->ts_fp19 = (double)OSSwapInt64((int64_t)fp->ts_fp19);
	fp->ts_fp20 = (double)OSSwapInt64((int64_t)fp->ts_fp20);
	fp->ts_fp21 = (double)OSSwapInt64((int64_t)fp->ts_fp21);
	fp->ts_fp22 = (double)OSSwapInt64((int64_t)fp->ts_fp22);
	fp->ts_fp23 = (double)OSSwapInt64((int64_t)fp->ts_fp23);
	fp->ts_fp24 = (double)OSSwapInt64((int64_t)fp->ts_fp24);
	fp->ts_fp25 = (double)OSSwapInt64((int64_t)fp->ts_fp25);
	fp->ts_fp26 = (double)OSSwapInt64((int64_t)fp->ts_fp26);
	fp->ts_fp27 = (double)OSSwapInt64((int64_t)fp->ts_fp27);
	fp->ts_fp28 = (double)OSSwapInt64((int64_t)fp->ts_fp28);
	fp->ts_fp29 = (double)OSSwapInt64((int64_t)fp->ts_fp29);
	fp->ts_fp30 = (double)OSSwapInt64((int64_t)fp->ts_fp30);
	fp->ts_fp31 = (double)OSSwapInt64((int64_t)fp->ts_fp31);
}
#endif /* !defined(RLD) */
