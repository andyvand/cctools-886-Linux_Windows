...
struct segment_spec {
    ...
    unsigned char addr_specified;	/* TRUE if address has been specified */
    unsigned char prot_specified;	/* TRUE if protection has been specified */
    ...
    unsigned char processed;	/* TRUE after this has been processed */
};
...
struct section_spec {
    ...
    unsigned char align_specified;	/* TRUE if alignment has been specified */
