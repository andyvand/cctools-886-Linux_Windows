...
__private_extern__ unsigned char search_paths_first;
...
struct dynamic_library {
    ...
    char *umbrella_name;
    char *library_name;
    unsigned char indirect_twolevel_ref_flagged;
    unsigned char some_non_weak_refs;
    unsigned char some_symbols_referenced;
    unsigned char force_weak_dylib;
    ...
    unsigned char twolevel_searched;
