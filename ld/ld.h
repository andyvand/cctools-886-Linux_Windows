...
__private_extern__ unsigned char multi_module_dylib;
...
__private_extern__ unsigned char specific_arch_flag;

/*
 * The -force_cpusubtype_ALL flag.
 */
__private_extern__ unsigned char force_cpusubtype_ALL;

/* the byte sex of the output file */
__private_extern__ enum byte_sex target_byte_sex;

__private_extern__
unsigned char trace;		/* print stages of link-editing */
__private_extern__
unsigned char save_reloc;		/* save relocation information */
__private_extern__
unsigned char output_for_dyld;	/* produce output for use with dyld */
__private_extern__
unsigned char bind_at_load;		/* mark the output for dyld to be bound
				   when loaded */
__private_extern__
unsigned char no_fix_prebinding;	/* mark the output for dyld to never
				   run fix_prebinding */
__private_extern__
unsigned char load_map;		/* print a load map */
__private_extern__
unsigned char define_comldsyms;	/* define common and link-editor defined
					   symbol reguardless of file type */
__private_extern__
unsigned char seglinkedit;		/* create the link edit segment */
__private_extern__
unsigned char whyload;		/* print why archive members are
					   loaded */
__private_extern__
unsigned char flush;		/* Use the output_flush routine to flush
				   output file by pages */
__private_extern__
unsigned char sectorder_detail;	/* print sectorder warnings in detail */
__private_extern__
unsigned char nowarnings;		/* suppress warnings */
__private_extern__
unsigned char no_arch_warnings;	/* suppress wrong arch warnings */
__private_extern__
unsigned char arch_errors_fatal;	/* cause wrong arch errors to be fatal */
__private_extern__
unsigned char archive_ObjC;		/* objective-C archive semantics */
__private_extern__
unsigned char archive_all;		/* always load everything in archives */
__private_extern__
unsigned char keep_private_externs;	/* don't turn private externs into
					   non-external symbols */
/* TRUE if -dynamic is specified, FALSE if -static is specified */
__private_extern__ unsigned char dynamic;
...
__private_extern__ unsigned char strip_base_symbols;

/* strip dead blocks */
__private_extern__ unsigned char dead_strip;
/* don't strip module init and term sections */
__private_extern__ unsigned char no_dead_strip_inits_and_terms;
/* print timings for dead striping code */
__private_extern__ unsigned char dead_strip_times;
...
__private_extern__ unsigned char nomultidefs;
...
__private_extern__ unsigned char prebinding;
__private_extern__ unsigned char prebind_allow_overlap;
__private_extern__ unsigned char prebind_all_twolevel_modules;

/* True if -m is specified to allow multiply symbols, as a warning */
__private_extern__ unsigned char allow_multiply_defined_symbols;

/* The segment alignment */
__private_extern__ unsigned long segalign;
#ifndef RLD
__private_extern__ unsigned char segalign_specified;
#endif /* !defined(RLD) */
...
__private_extern__ unsigned char seg1addr_specified;

/* read-only and read-write segment addresses */
__private_extern__ unsigned long segs_read_only_addr;
__private_extern__ unsigned char segs_read_only_addr_specified;
__private_extern__ unsigned long segs_read_write_addr;
__private_extern__ unsigned char segs_read_write_addr_specified;

/* The stack address and size */
__private_extern__ unsigned long stack_addr;
__private_extern__ unsigned char stack_addr_specified;
__private_extern__ unsigned long stack_size;
__private_extern__ unsigned char stack_size_specified;

/* TRUE if -allow_stack_execute is specified */
__private_extern__ unsigned char allow_stack_execute;
 ...
 */
__private_extern__ unsigned char headerpad_max_install_names;
...
__private_extern__ unsigned char sub_framework;
__private_extern__ unsigned char umbrella_framework;
...
__private_extern__ unsigned char private_bundle;
...
__private_extern__ unsigned char ld_trace_archives;

/* TRUE if the environment variable LD_TRACE_DYLIBS
   (or temporarily RC_TRACE_DYLIBS) is set */
__private_extern__ unsigned char ld_trace_dylibs;

/* TRUE if the environment variable LD_TRACE_PREBINDING_DISABLED
   (or temporarily RC_TRACE_PREBINDING_DISABLED) is set */
__private_extern__ unsigned char ld_trace_prebinding_disabled;

/* the argument to -final_output if any */
__private_extern__ char *final_output;

/* The variables to support namespace options */
__private_extern__ unsigned char namespace_specified;
__private_extern__ unsigned char twolevel_namespace;
__private_extern__ unsigned char force_flat_namespace;

__private_extern__ unsigned char twolevel_namespace_hints;
