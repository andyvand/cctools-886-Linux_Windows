 ...
 */
__private_extern__ unsigned char save_lazy_symbol_pointer_relocs;
...
__private_extern__ unsigned char indirect_live_ref(
...
__private_extern__ unsigned char legal_reference(
