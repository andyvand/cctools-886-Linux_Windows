 ...
 */
struct uuid_info {
    unsigned char suppress;	/* suppress when -no_uuid is specified */
    unsigned char emit;	/* TRUE if any input file has a debug section or
...
struct thread_info {
    ...
    unsigned char thread_in_output;	/* TRUE if the output file has a thread cmd */
...
struct routines_info {
    ...
    unsigned char routines_in_output;/* TRUE if the output file has a routines cmd*/
};
