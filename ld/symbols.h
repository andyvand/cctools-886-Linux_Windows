...
struct string_block {
    ...
    unsigned char base_strings;	/* TRUE if this block is for strings from the */
				/*  base file (used if strip_base_symbols is */
				/*  TRUE) */
    unsigned char dylib_strings;	/* TRUE if this block is for strings from a */
...
struct sect_object_symbols {
    unsigned char specified; /* if this has been specified on the command line */
 ...
 */
__private_extern__ unsigned char merged_symbols_relocated;
...
__private_extern__ unsigned char is_output_local_symbol(
