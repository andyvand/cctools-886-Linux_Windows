...
struct merged_segment {
	...
	*zerofill_sections;
    ...
    unsigned char addr_set;		/* TRUE when address of this segment is set */
    unsigned char prot_set;		/* TRUE when protection of this segment is set*/
    unsigned char split_dylib;	/* TRUE when this segment is from a dylib */
				/*  which is MH_SPLIT_SEGS */
    unsigned char debug_only;	/* TRUE if segment contains sections with the */
...
struct merged_section {
    ...
    unsigned char relocated;	/* This section was relocated */
    unsigned char referenced;	/* This section was referenced by a relocation*/
 ...
 */
__private_extern__ unsigned char some_non_subsection_via_symbols_objects;
...
__private_extern__ void merge_literal_sections(
    unsigned char redo_live);
__private_extern__ void layout_ordered_sections(
    void);
__private_extern__ unsigned char is_literal_output_offset_live(
...
__private_extern__ struct merged_section *lookup_merged_section(
    char *segname,
    char *sectname);
__private_extern__ unsigned char is_merged_symbol_coalesced(
    struct merged_symbol *merged_symbol);
