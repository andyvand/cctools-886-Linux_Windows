 ...
 */
static unsigned char local_NO_DEAD_STRIP_symbols = FALSE;
...
static char * find_stab_type_end(
    char *name_end);
#endif /* !defined(RLD) */
static unsigned char is_type_stab(
 ...
 */
static unsigned char commons_exist = FALSE;
static unsigned char noundefs = TRUE;
 ...
 */
__private_extern__ unsigned char merged_symbols_relocated = FALSE;
...
merge_symbols(void)
{
    ...
    unsigned char discarded_coalesced_symbol;
    unsigned char discarded_multiply_defined_symbol;
    unsigned short n_desc;
    size_t * debug_ptr;

#ifndef RLD
    unsigned long nest, sum, k;
    unsigned char no_exclusion;
...
struct dynamic_library *dynamic_library)
{
    ...
    unsigned long flags;
    unsigned char was_traced, resolve_flat;
    struct merged_symbol *hash_pointer, *merged_symbol;
...
mark_globals_live(void)
{
    ...
    struct merged_symbol_list *merged_symbol_list;
    struct merged_symbol *merged_symbol;
    unsigned char only_referenced_dynamically;
...
struct section_map *section_map)
{
    ...
    struct fine_reloc *fine_reloc;
    unsigned char closed_last_block;
    size_t * debug_ptr;
...
void)
{
    ...
    struct merged_symbol_list *merged_symbol_list;
    struct merged_symbol *merged_symbol;
    unsigned char printed_undef, allowed_undef, prebound_undef;
    struct object_list *object_list, **q;
#ifndef RLD
    unsigned long k;
    struct nlist *object_symbols;
    ...
    unsigned char reported, weak_ref_warning;
#endif
...
void)
{
    ...
    unsigned char rebuild_merged_string_table;
 ...
 * work.
 */
static unsigned char some_read_only_reloc_flags_set = FALSE;
...
remove_merged_symbols(void)
{
    ...
    unsigned char have_some_symbols;
