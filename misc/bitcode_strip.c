...
static unsigned char rflag = FALSE; /* remove bitcode segment */
static unsigned char mflag = FALSE; /* remove bitcode but leave a marker segment */
static unsigned char lflag = FALSE; /* leave only bitcode segment */
static unsigned char vflag = FALSE; /* to print internal commands that are run */
 ...
 * bitcode.
 */
static unsigned char some_slice_has_bitcode = FALSE;
...
static unsigned char check_object(
    struct arch *arch,
