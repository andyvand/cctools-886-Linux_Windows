...
#endif
static unsigned char archives_in_input = FALSE;

/* flags set from command line arguments to specify the operation */
static unsigned char create_flag = FALSE;
static unsigned char info_flag = FALSE;
static unsigned char detailed_info_flag = FALSE;

static unsigned char thin_flag = FALSE;
static struct arch_flag thin_arch_flag = { 0 };

static unsigned char remove_flag = FALSE;
static struct arch_flag *remove_arch_flags = NULL;
static uint32_t nremove_arch_flags = 0;

static unsigned char extract_flag = FALSE;
static struct arch_flag *extract_arch_flags = NULL;
static uint32_t nextract_arch_flags = 0;
static unsigned char extract_family_flag = FALSE;

static unsigned char replace_flag = FALSE;
struct replace {
    struct arch_flag arch_flag;
...
static unsigned char arch_blank_flag = FALSE;
...
static unsigned char verify_flag = FALSE;
...
static uint32_t rnd(
    uint32_t v,
    uint32_t r);
static unsigned char ispoweroftwo(
    uint32_t x);
