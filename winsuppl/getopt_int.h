...
#ifndef _GETOPT_DATA_INITIALIZER
#define _GETOPT_DATA_INITIALIZER { 1, 1 }
#endif /* _GETOPT_DATA_INITIALIZER */

extern int _getopt_internal_r (int ___argc, TCHAR *const *___argv,
			       const TCHAR *__shortopts,
			       const option_t *__longopts, int *__longind,
			       int __long_only, getopt_data *__data,
			       int posixly_correct);
