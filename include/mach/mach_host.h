...
)
{
    ...
    host_info[0] = CPU_TYPE_ARM;
#elif defined(_M_ARM64)   || defined(_ARM64_) || \
      defined(_M_AARCH64) || defined(_AARCH64_) || \
      defined(__arm64__)  || defined(__aarch64__)
    host_info[0] = CPU_TYPE_ARM64;
#elif defined(_M_IX86) || defined(_M_X86) || defined(_X86_) || \
      defined(_IX86_) || defined(__i386__)
    host_info[0] = CPU_TYPE_I386;
#elif defined(_M_AMD64) || defined(_M_X64) || defined(_X64_) || \
      defined(_AMD64_)  || defined(__x86_64__)
    host_info[0] = CPU_TYPE_X86_64;
#else
#error "Architecture needs to be set in host_info"
#endif

    if (host_info_count != NULL)
        host_info_count[0] = 1;
...
{
    char ERRS[MAX_PATH];
    char *StringErrorPtr = (char *)ERRS;

#if defined(_MSC_VER) && __STDC_WANT_SECURE_LIB__
    strerror_s(StringErrorPtr, sizeof(ERRS), X);
#else
    StringErrorPtr = strerror(X);
#endif

    return StringErrorPtr;
}
#endif
#ifndef mach_error_string
#define mach_error_string(X) StringError(X)
#endif
#endif /* mach_error_string */

#ifndef mach_host_self
#ifndef __linux__
#define mach_host_self GetCurrentProcessId
#else /* __linux__ */
#define mach_host_self getpid
#endif /* __linux__ */
#endif /* mach_host_self */
