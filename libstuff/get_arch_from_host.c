 ...
 */
__private_extern__
int get_arch_from_host(struct arch_flag *family_arch_flag, struct arch_flag *specific_arch_flag)
{
...
#endif
#else
#if defined(__i386__) || defined(_X86_) || defined(_M_X86) || defined(_IX86_) || defined(_M_IX86)
        host_basic_info.cpu_type = CPU_TYPE_I386;
	host_basic_info.cpu_subtype = CPU_SUBTYPE_I386_ALL;
#elif defined(__x86_64__) || defined(_AMD64_) || defined(_M_AMD64) || defined(_X64_) || defined(_M_X64)
        host_basic_info.cpu_type = CPU_TYPE_X86_64;
	host_basic_info.cpu_subtype = CPU_SUBTYPE_I386_ALL;
#elif defined(__arm__) || defined(_ARM_) || defined(_M_ARM)
        host_basic_info.cpu_type = CPU_TYPE_ARM;
	host_basic_info.cpu_subtype = CPU_SUBTYPE_ARM_ALL;
#elif defined(__arm64__) || defined(__aarch64__) || defined(_ARM64_) || defined(_M_ARM64) || defined(_AARCH64_) || defined(_M_AARCH64)
        host_basic_info.cpu_type = CPU_TYPE_ARM64;
	host_basic_info.cpu_subtype = CPU_SUBTYPE_ARM_ALL;
#elif defined(__ppc__) || defined(_PPC_) || defined(_M_PPC)
        host_basic_info.cpu_type = CPU_TYPE_PPC;
	host_basic_info.cpu_subtype = CPU_SUBTYPE_PPC_ALL;
#elif defined(__ppc64__) || defined(_PPC64_) || defined(_M_PPC64)
        host_basic_info.cpu_type = CPU_TYPE_PPC64;
	host_basic_info.cpu_subtype = CPU_SUBTYPE_PPC_ALL;
#else
#error "FIXME: Implement architecture..."
#endif
    ...
    case CPU_TYPE_POWERPC:
        ...
        if (specific_arch_flag != NULL)
        {
            specific_arch_flag->name = savestr("PowerPC cpusubtype 1234567890");

            if (specific_arch_flag->name != NULL)
            {
#if defined(_MSC_VER) && __STDC_WANT_SECURE_LIB__
                sprintf_s(specific_arch_flag->name, strlen(specific_arch_flag->name),
#else
                snprintf(specific_arch_flag->name, strlen(specific_arch_flag->name),
#endif
