...
const char *root)
{
	...
	while((ftsent = fts_read(fts)) != NULL){
...
#endif
#if defined(_WIN32) || defined(WIN32)
        if (strcmp(base_name, ftsent->fts_name)){
#else
		...
		if(block.check_result == TRUE){
            ...
            strcpy_s(image_file_name, ftsent->fts_pathlen, ftsent->fts_path);
#else
		    strncpy(image_file_name, ftsent->fts_path, ftsent->fts_pathlen);
#endif
