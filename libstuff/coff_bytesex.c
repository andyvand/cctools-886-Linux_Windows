...
__private_extern__
void swap_base_relocation_block_header(struct base_relocation_block_header *h, enum byte_sex target_byte_sex)
{
...
enum byte_sex target_byte_sex)
{
    ...
    unsigned char to_host_byte_sex;
	...
	to_host_byte_sex = (unsigned char)(target_byte_sex == host_byte_sex);
	for(i = 0; i < n; i++){
	    if(to_host_byte_sex){
